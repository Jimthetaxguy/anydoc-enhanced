...
| `crates/pdf-inspector-skillkit/src/vertical_text.rs` | PDF fonts under vertical CMaps, their strings gathered into columns by where they start, and the neighbouring columns whose heights overlap, right to left, which pdf-inspector 1.24.0 lays out as horizontal (upstream #575) |
